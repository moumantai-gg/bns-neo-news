# September 16, 2026 Shop & Event Notices

## 1. Soul Pass Guide

Translated from the official [event notice](https://bns.plaync.com/board/neonotice/view?articleId=6aa9ec686b722c561dc6a599),
posted 2026-09-16 02:02 KST.

Greetings, Warriors.

The Soul Pass, made even richer for Chuseok!

**Mission period:** After the September 16 (Wed), 2026 regular maintenance –
before the October 21 (Wed), 2026 regular maintenance
**Reward claim period:** After the September 16 (Wed), 2026 regular
maintenance – before the October 28 (Wed), 2026 regular maintenance

*If any reward goes unclaimed after the mission period ends, it can still be
claimed from the Soul Pass (F11)'s Unclaimed Rewards tab until before the
October 28, 2026 regular maintenance.*

**How to participate**
1. Click Soul Pass (F11).
2. Click the [Purchase Soul Pass Plus] button to unlock Soul Pass Premium
   rewards.
   - Soul Pass Premium benefits apply per character (once per character).
   - However, within Soul Pass Plus's convenience features listed below,
     the benefit is shared with same-server characters on your account (a
     NEO-server character's purchase is shared with your other NEO-server
     characters; a Specialization-server character's purchase is shared
     with your other Specialization-server characters): Remote Storage use,
     Soul Storage use, and instant use of stored Warehouse items as
     refining/transmute/crafting materials.
   - *Soul Pass Plus's convenience features apply from purchase until
     before the October 21, 2026 regular maintenance.*
   - NEO server: 2,400 Divine Gems. Specialization server: Specialization
     Soul Pass Ticket — purchasable at the BnS Shop (F10), usable only once
     per character, usable until before the October 21, 2026 regular
     maintenance.
3. Complete missions to reach pass levels and earn their rewards.
4. For faster pass leveling, click the [Pass Level Up] button to earn Soul
   Pass Points.
   - Pass level-up purchases are only available up to Soul Pass level 30.
   - Each pass level-up purchase grants 1,000 Soul Pass Points.
   - NEO server: 110 Divine Gems. Specialization server: Specialization
     Soul Pass Level-Up — purchasable up to 30 times per character via the
     Dragon Express button at the bottom of Inventory (I), usable until
     before the October 21, 2026 regular maintenance.
...
Earthseers Premium Resuscitation Charm ×10, Cheongungdanggwi Recovery
Potion ×150, Onion Kalguksu ×150, Hongmoon Blessing Potion (Timed) ×12, and
[Specialization] Transformation Stone Crystal ×120.

**Component details**

| Item | Description |
|---|---|
| Hongmoon Soul Gold Coin Box | Opening grants 1–20 Hongmoon Certificate: 1 Gold, at set odds. |
| Chuseok Lucky Portrait Box Bundle | Opening grants 1 Black Dragon Portrait Box (Heroic–Legendary) (Pack of 3–5) and 1 Black Dragon Special Portrait Box (Heroic–Legendary) (Pack of 1–3). |
| Black Dragon Portrait Box (Heroic–Legendary) (Pack of 3–5) | Opening grants, at set odds, 1 of 3–5 Black Dragon Portrait Box (Heroic–Legendary). |
| Black Dragon Portrait Box (Heroic–Legendary) | Opening grants, at set odds, 1 of Black Dragon Portrait Box (Heroic) or Dawncrest Portrait Box (Legendary). |
| Black Dragon Portrait Box (Heroic) | Opening grants one of 53 Heroic Portraits, including [the Black Dragon Cult Leader], at set odds. |
| Dawncrest Portrait Box (Legendary) | Opening grants one of 14 Legendary Portraits, including Jinsoyun, Master Hong, Alternate-Timeline Zulia, and Shadow Lord Rahu, at set odds. |
| Black Dragon Special Portrait Box (Heroic–Legendary) (Pack of 1–3) | Opening grants, at set odds, 1 of 1–3 Black Dragon Special Portrait Box (Heroic–Legendary). |
...
| Hongmoon Blessing Potion (Timed) | Using it restores 30 Hongmoon Blessing. *Usable until before the October 28, 2026 regular maintenance.* |
| [Specialization] Transformation Stone Crystal | Usable for equipment effect reset and similar uses. |

*Obtained Portraits can be checked in the Portrait Book (Ctrl+B); register
collected Portraits in the [Bonds] tab, then [Activate] the Bond to gain
additional stats. Stats gained this way are shared with characters on the
same server.*

### Full Moon Coin Progression & Exchange

Soul Pass Full Moon Coin — obtain up to 40: reach Soul Pass level 30 to
receive 30 Coins; after level 30, receive 1 additional Coin for every 1,000
Soul Pass Points reached (up to 10 additional). A Full Moon Soul Support
Box, also obtainable this way, opens into 1 Soul Pass Full Moon Coin and 1
Soul Support Box.
...
required, available until before the October 28, 2026 regular maintenance:

| Coins | Exchange item | Exchange limit |
|---|---|---|
| 20 | Gold Line Steel/Gold Line Jade (Pack of 10) Selection Box (Account Bound) | 1× per account |
| 20 | Legendary Skill Book Fragment Selection Box (Superior) | 1× per account |
| 20 | Dawncrest Portrait Box (Legendary) | 1× per account |
...
**Legendary Skill Book Fragment Selection Box (Superior)** — opening lets
you choose 1 of:
- A Legendary Skill Book Fragment — a material for Radiant Skill Book
  Box/Secret Skill Book transmute attempts.
- A Soul Pass Legendary Bound Skill Book Fragment (Superior) — together with
  a Soul Pass Legendary Bound Skill Book Fragment (Basic), exchangeable for
  a Bound Black Dragon Skill Book Chest (Legendary). *Usable until before
  the November 25, 2026 regular maintenance.* *(The Basic-grade fragment is
  obtainable by purchasing next season's Soul Pass.)*

**Gold Line Steel/Gold Line Jade (Pack of 10) Selection Box** — opening
lets you choose and obtain 1 of 10 Gold Line Steel or 10 Gold Line Jade.
(Account Bound)

**Sagewood Soul Shield Chest** — opening grants one of 8 Sagewood Soul
Shields, at set odds. (Account Bound)

**Master's Portrait (Legendary)** / **Special: Master's Portrait (Heroic)**
— usable only as Legendary/Special Heroic Portrait fusion material; can't
be used for Bonds or the collection.

### Costume Exchange (Soul Pass Costume Coin)

Soul Pass Costume Coin (Account Bound) ×3 is also obtainable as a Premium
reward — usable at the Dragon Express to exchange for various costumes.
...
*Above exchanges use the Soul Pass Full Moon Coin as their coin cost,
available until before the October 28, 2026 regular maintenance.*

### General Rewards

Featured items: Soul EXP Chest ×5, Earthseers Revival Charm ×5, and
Cheongungdanggwi Recovery Potion ×50.

**Soul EXP Chest** — opening requires choosing an item to open it with:
- With a Dawncrest Isle Key: grants 1 Soul Pass EXP Charm (10K) (10,000
  EXP).
- With a Soul EXP Chest Key: grants, at set odds, [NEO server] a Soul Pass
  EXP Increase Pill (50%) (+50% combat EXP for 30 min), or [Specialization
  server] 1 Soul Pass EXP Charm (100K) (100,000 EXP).
- *Usable until before the October 28, 2026 regular maintenance.*

**Earthseers Revival Charm** — a personal revival charm usable to revive
the character on Exhaustion or Death. *15-min cooldown.*

**Cheongungdanggwi Recovery Potion** — an item that restores 126,480 HP
over 10 seconds.

## 2. [NEO Server] Jin/Lyn: Martial World Moon Costume Box Guide

Translated from the official [sale notice](https://bns.plaync.com/board/neonotice/view?articleId=6aa9ec68eea53f5d6dbcf771),
posted 2026-09-16 02:05 KST.

Greetings, Warriors.

After the September 16 (Wed), 2026 regular maintenance, the "Martial World
Moon Costume Box" and "Special Martial World Moon Costume Box" go on sale
in the Blade & Soul NEO Shop.

The Martial World Moon Costume Box has a chance to grant a Full Moon Coin;
the Special Martial World Moon Costume Box guaranteed-grants one.
...
**[Blade & Soul NEO Shop] NEO (Jin/Lyn Server) Store "Martial World Moon" &
"Special Martial World Moon" Costume Box release**
...
- **Sale period:** After the September 16 (Wed), 2026 regular maintenance –
  before the September 30 (Wed), 2026 regular maintenance
- **Items for sale**

| Item | Contents | Description | Price (Divine Gems) | Purchase limit |
|---|---|---|---|---|
| Martial World Moon Costume Box | Seolhong-ui Costume Box, Seonimja Costume Box, or Full Moon Costume Set Box | Opening grants 1 of the 3 at set odds | 500 | No limit |
| | Full Moon Coin | Opening grants 1, at set odds | | |
| Special Martial World Moon Costume Box | 3× Seolhong-ui Costume Box, 3× Seonimja Costume Box, 1× Full Moon Costume Set Box | Opening grants 1 of the 3 at set odds | 1,500 | No limit |
| | Full Moon Coin | Opening guaranteed-grants 1 | | |

**Full Moon Coin**
Not tradable; sells to an NPC vendor for 10 Gold; exchangeable at the
Dragon Express; usable until before the October 7, 2026 regular
maintenance. Collect Full Moon Coins and exchange them at the Dragon
Express for whichever item you want.

**Dragon Express exchange list**
...
| 15 | — | Black Mystic Illusion Weapon Box | 1 |
...
- The Legendary-grade Full Moon Costume Set Box and Black Mystic Set Box
  carry very high in-game value.
- Full Moon Coin drops from the Martial World Moon Costume Box at set odds;
  the Special Martial World Moon Costume Box guaranteed-grants one on
  opening.
...
*Full Moon Costume Set Box, Seolhong-ui Costume Box, Seonimja Costume Box,
Black Mystic Set Box: Marketplace: No / NPC sale: Yes / Salvage: No.*
*Full Moon Costume, Full Moon Headpiece, Black Mystic, Black Mystic
...
sale: Yes / Salvage: Yes / Tailor: No.*
...
**※ Must read! Cautions**
1. This item is exclusive to the NEO server and can't be used on the
...
We appreciate all our BNS NEO customers' interest.

Thank you.

## 3. Ruler of the Land Collaboration: New Achievements & Titles Notice

Translated from the official [event notice](https://bns.plaync.com/board/neonotice/view?articleId=6aa9ec686b722c561dc6a5a6),
posted 2026-09-16 02:12 KST.

Greetings, Warriors.

Thank you for enjoying the B&S NEO x Ruler of the Land collaboration.
New achievements and titles have been added — details below.
...
everyone who spent 2,000 or more Hongmoon Blessing between the August 19
(Wed), 2026 regular maintenance and before the September 16 (Wed), 2026
regular maintenance, 100 winners will be chosen by lottery and sent the
item by in-game mail.

| Achievement | Description | Title |
|---|---|---|
| Fervent Growth | Use a Fervent Hwandan | Grown Fervently |

*Only 1 character per account can win the lottery per week.*
*The Fervent Hwandan item will be sent out sequentially after the September
16 (Wed) regular maintenance.*

**※ Cautions**
- Sanctioned accounts cannot participate in this event.
- The same or similar promotion may be run again in the future.
- Event schedule or rewards may change during the event, and improper
